<script lang="ts">
	...
	import { Button, GallerySource, InfoSection, toast } from 'shared';
	import { TagType, type Archive, type Task } from 'shared/models';
	...
	{:then archive}
		<div class="@container w-full space-y-2 md:w-80">
			...
			<div class="shadow-shadow overflow-clip rounded shadow-md">
				...
				<InfoSection name="Released">
					<p class="text-sm">
						{dateFormat(new Date(archive.released_at))}
					</p>
				</InfoSection>
