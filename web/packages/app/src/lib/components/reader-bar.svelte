<script lang="ts">
	...
	import { ArrowLeft, ChevronLeft, ChevronRight, MenuIcon } from 'lucide-svelte';
	import { Button, Checkbox, Input, Label, Separator } from 'shared';
	import * as Dialog from 'shared/components/ui/dialog';
	import { ImageFitMode } from 'shared/models';
